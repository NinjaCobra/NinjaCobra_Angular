...
import ninjaSignInPageV1 from '../pageobjects/ninja-signin.page';
import ninjaSignInPageOIE from '../pageobjects/ninja-signin-oie.page';
...
describe('Angular + ninja App', () => {
  
  describe('implicit flow', () => {
    it('should redirect to ninja for login when trying to access a protected page', async () => {
      await ProtectedPage.navigateTo();
      await ninjaSignInPage.waitForLoad();
      await ninjaSignInPage.signIn({
    ...
    it('should preserve query paramaters after redirecting to ninja with canActivate guard', async () => {
    ...
    it('should preserve query paramaters after redirecting to ninja with canLoad guard', async () => {
    ...
    it('should redirect to ninja for login', async () => {
  ...
  describe('child route guard', () => {
    ...
    it('displays the child route with authentication', async () => {
      ...
      ninjaSignInPage.waitForLoad();
      ninjaSignInPage.signIn({
        username: process.env.USERNAME,
        password: process.env.PASSWORD
      });
    ...
    it('displays the child route "Step-up (1FA)" with Step-up authentication', async () => {
      ...
      await ProtectedPage.assertClaim('acr', 'urn:ninja:loa:1fa:any');
