...
const getTask = (taskConfig) => () => {
  return new Promise(resolve => {
    const { app, name, asyncninjaConfig } = taskConfig;
    ...
    const server = spawn(`yarn`, [
      ...
      env: {
        ...process.env,
        ASYNC_ninja_CONFIG: asyncninjaConfig ? '1' : '0',
      }
    });
...
const tasks = [
  {
    name: '@ninja/test.app.ng12',
    app: 'angular-v12'
  },
  {
    name: '@ninja/test.app.ng13',
    app: 'angular-v13'
  },
  {
    name: '@ninja/test.app.ng14',
    app: 'angular-v14'
  },
  {
    name: '@ninja/test.app.ng15',
    app: 'angular-v15',
    asyncninjaConfig: true
  },
  {
    name: '@ninja/test.app.ng16',
    app: 'angular-v16',
    asyncninjaConfig: true
  },
]
